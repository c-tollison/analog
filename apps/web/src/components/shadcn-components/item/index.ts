...
export const itemVariants = cva(
    '[a]:hover:bg-muted [button]:hover:bg-muted [label]:hover:bg-muted [button]:text-left rounded-md border text-xs/relaxed group/item flex w-full flex-wrap items-center transition-colors duration-100 outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 [a]:transition-colors',
    {
        variants: {
            variant: {
